...
<div class="card" style="margin: 15px;" >
  ...
  <h4 style="margin:0";>Forma per Shtimin e Aplikacioneve per Pune </h4>
</div>
  <div class="card-body">
      ...
      <form action="<?php echo e(url('aplikacionPune')); ?>" method="post">
        ...
        <input type="submit" value="Ruaj" style="padding: 4px 26px; border-radius: 3px;" class="btn btn-success"></br>
    </form>
  
  </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('aplikacionePune.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\xampp\htdocs\UMAP\laravel_crud\resources\views/aplikacionePune/create.blade.php ENDPATH**/ ?>